...
const imageURL = useSelector((state) => {
  ...
  return (
    <Link to={`/${data.media_type}/${data.id}`} className="w-full min-w-[230px]  h-[345px]  rounded-md overflow-hidden relative transition-all hover:cursor-pointer hover:scale-105">
